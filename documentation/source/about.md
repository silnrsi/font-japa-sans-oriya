---
title: Japa Sans Oriya - About
fontversion: 2.200
---

## About this project

The Japa Sans Oriya family of fonts supports the broad variety of writing systems
that use the Oriya script.

The Latin glyphs are based on Noto Sans. The Oriya glyphs are based on Noto Sans Oriya.
...
- New additions to [The Unicode Standard](https://unicode.org/)
  - Dot above and double dot above characters may be added to the Oriya Unicode block in the future. When those are added, the font will be updated to use those codepoints instead of U+0307 and U+0308.
- Requests from language communities using the fonts
- Needs of the linguistic and academic community

Please submit requests using the [issue tracker on the font repository](https://github.com/silnrsi/font-japa-sans-oriya/issues). If you are interested in helping us make the fonts better see the [Developer](developer.md) page.
