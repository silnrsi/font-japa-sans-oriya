...
def doit(args):
    ...
    if test.lower().startswith("diac"):
        ...
        repDiac = list(filter(lambda x: x in builder.uids(), (0x0B01, 0x0B02, 0x0B03, 0x0B55, 0x0307, 0x0308, nukta)))
        repBase = list(filter(lambda x: x in builder.uids(), (0x0B15, 0x0B2A, dotted_circle)))
